...
class Interceptor extends \Itoris\DynamicProductOptions\Model\Rewrite\Product\Type\Configurable implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItorisHelper');
        if (!$pluginInfo) {
            return parent::getItorisHelper();
        } else {
            return $this->___callPlugins('getItorisHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItorisProductTypeHelper');
        if (!$pluginInfo) {
            return parent::getItorisProductTypeHelper();
        } else {
            return $this->___callPlugins('getItorisProductTypeHelper', func_get_args(), $pluginInfo);
        }
    }
