...
class Interceptor extends \Itoris\ProductPriceFormula\Model\Rewrite\Quote\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormulaPrice');
        if (!$pluginInfo) {
            return parent::getFormulaPrice();
        } else {
            return $this->___callPlugins('getFormulaPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCatalogPriceInclTax');
        if (!$pluginInfo) {
            return parent::isCatalogPriceInclTax();
        } else {
            return $this->___callPlugins('isCatalogPriceInclTax', func_get_args(), $pluginInfo);
        }
    }
